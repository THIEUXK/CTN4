...
namespace CTN4_Data.DB_Context
{
    public class DB_CTN4_ok:DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-JV9E5UC\\SQLEXPRESS;Initial Catalog =CTN4;MultipleActiveResultSets=True;User ID=toanck;Password=123456789");
        }
