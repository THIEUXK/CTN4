        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenChatLieu = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MaKhuyenMai = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    PhanTramGiamGia = table.Column<int>(type: "int", maxLength: 10, nullable: false),
                    NgayBatDau = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NgayKetThuc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SoTienGiam = table.Column<float>(type: "real", maxLength: 30, nullable: false),
                    DongGia = table.Column<float>(type: "real", maxLength: 30, nullable: false),
                    TrangThai = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenMau = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    TrangThai = table.Column<bool>(type: "bit", nullable: false),
                    Is_detele = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenNSX = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    TrangThai = table.Column<bool>(type: "bit", nullable: false),
                    GhiChu = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Is_detele = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenPhanLoai = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenSize = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TienHang = table.Column<float>(type: "real", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoSua = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DanhGiaSanPhams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DanhGiaSanPhams_KhachHangs_IdKhachHang",
                        column: x => x.IdKhachHang,
                        principalTable: "KhachHangs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DanhGiaSanPhams_SanPhams_IdSanPham",
                        column: x => x.IdSanPham,
                        principalTable: "SanPhams",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("d16ac327-3ced-4c2c-bcdc-d3897121444a"), new Guid("56dd3ee2-c4df-4376-b982-e2c0f7081166"), new Guid("56dd3de2-c4df-4376-b982-e2c0f7081825") },
                    { new Guid("d16ac327-3ced-4c2c-bcdc-d3897121445a"), new Guid("56dd3ee2-c4df-4376-b982-e2c0f7081167"), new Guid("56dd3de2-c4df-4376-b982-e2c0f7081826") },
                    { new Guid("d16ac327-3ced-4c2c-bcdc-d3897121446a"), new Guid("56dd3ee2-c4df-4376-b982-e2c0f7081168"), new Guid("56dd3de2-c4df-4376-b982-e2c0f7081827") },
                    { new Guid("d16ac327-3ced-4c2c-bcdc-d3897121447a"), new Guid("56dd3ee2-c4df-4376-b982-e2c0f7081169"), new Guid("56dd3de2-c4df-4376-b982-e2c0f7081828") },
                    { new Guid("d16ac327-3ced-4c2c-bcdc-d3897121448a"), new Guid("56dd3ee2-c4df-4376-b982-e2c0f7081170"), new Guid("56dd3de2-c4df-4376-b982-e2c0f7081829") }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DanhGiaSanPhams_IdKhachHang",
                table: "DanhGiaSanPhams",
                column: "IdKhachHang");

            migrationBuilder.CreateIndex(
                name: "IX_DanhGiaSanPhams_IdSanPham",
                table: "DanhGiaSanPhams",
                column: "IdSanPham");
