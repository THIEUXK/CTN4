...
namespace CTN4_View.Areas.Admin.Controllers.QuanLyVouvher
{
    ...
    public class VoucherController : Controller
    {
        ...
        [HttpGet]
        public ActionResult Index(GiamGiaFilter filter, string MaGiam, int? size, int? page, bool? loaiGiamGia, bool? Is_detele) /*, DateTime Ngaybatdau, DateTime Ngayketthuc*//*, float from, float to*/
        {



            
                ViewBag.currentLoaiGiamGia = filter.LoaiGiamGia;
                ViewBag.currentIsDelete = filter.IsDelete;
        ...
        {
            // Kiểm tra kiểu dữ liệu của SoTienGiam
            //if (a.SoTienGiam.GetType() != typeof(float))
            //{
            //    ModelState.AddModelError("SoTienGiam", "Kiểu dữ liệu của SoTienGiam không đúng.");
            //    return View(a);
            //}
        ...
        //private bool IsValidSoTienGiamLength(float value)
        //{
